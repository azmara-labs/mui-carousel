...
const App = () => {
  ...
  return (
    <div className="root">
      ...
      <Typography variant="subtitle1" align="left">
        Current Maintainer: &nbsp;
        <a href="https://azmara.io" target="_blank" rel="noreferrer">
          Azmara Labs
        </a>
        &nbsp;(&nbsp;
        <a href="https://github.com/coderchef26" target="_blank" rel="noreferrer">
          Coder Chef
        </a>
        &nbsp;)
      </Typography>
      ...
      <div className="description">
        ...
        <div>
          ...
          <Typography>
            <a href="https://buymeacoffee.com/alghaazi" target="_blank" rel="noreferrer">
              Buy me a Coffee
            </a>
          </Typography>
          <Typography>
            <a href="https://www.paypal.me/alghaazi" target="_blank" rel="noreferrer">
              Support via PayPal
            </a>
          </Typography>
        </div>
